...
The toast can be dismissed automatically after a specific amount of time by passing the number of milliseconds to display it in the `duration` of the toast options. If `showActionButton` is set to true, then the close button will dismiss the toast. If `showCloseButton` is set to true, then the close button will dismiss the toast. To dismiss the toast after creation, call the `dismiss()` method on the instance.
...
| ------------------ | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ----------- |
| `actionButtonText` | `action-button-text` | Text to display in the action button.                                                                                                                                                                                                                                  | `string \| undefined`                                                                  | `undefined` |
...
| `showActionButton` | `show-action-button` | If `true`, the action button will be displayed.                                                                                                                                                                                                                        | `boolean`                                                                              | `false`     |
